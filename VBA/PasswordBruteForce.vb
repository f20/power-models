Function GuessSheetPassword(sheet As Worksheet) As String
  ' Author unknown but submitted by brettdj of www.experts-exchange.com
  ' Adapted by Franck Latremoliere
  ...
  For i5 = 65 To 66: For i6 = 65 To 66: For n = 32 To 126
    ...
    If sheet.ProtectContents = False Then
        GuessSheetPassword = Chr(i) & Chr(j) & Chr(k) & Chr(l) & Chr(m) & Chr(i1) & _
...
Sub GuessBookPassword(book As Workbook)
  ' Author unknown but submitted by brettdj of www.experts-exchange.com
  ' Adapted by Franck Latremoliere
  Dim i As Integer, j As Integer, k As Integer
  Dim l As Integer, m As Integer, n As Integer
  ...
  For i2 = 65 To 66: For i3 = 65 To 66: For i4 = 65 To 66
  For i5 = 65 To 66: For i6 = 65 To 66: For n = 32 To 126
    book.Unprotect Chr(i) & Chr(j) & Chr(k) & _
        Chr(l) & Chr(m) & Chr(i1) & Chr(i2) & Chr(i3) & _
        Chr(i4) & Chr(i5) & Chr(i6) & Chr(n)
    If book.ProtectStructure = False Then
        Exit Sub
    End If
  Next: Next: Next: Next: Next: Next
  Next: Next: Next: Next: Next: Next
